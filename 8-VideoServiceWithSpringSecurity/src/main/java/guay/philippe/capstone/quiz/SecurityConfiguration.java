...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		...
		http.formLogin()
			...
			.loginProcessingUrl(MutiboSvcApi.LOGIN_PATH)
		...
		http.logout()
			...
			.logoutUrl(MutiboSvcApi.LOGOUT_PATH)
		...
		//TODO: Enforce authentication on certain methods for each sub urls
		http
			.authorizeRequests()
				.antMatchers("/quiz/**").permitAll()
				.antMatchers("/player/**").permitAll()
				.antMatchers("/completedquiz/**").permitAll()
