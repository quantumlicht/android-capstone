...
public class VideoSvcClientApiTest {
	...
	private MutiboSvcApi videoService = new RestAdapter.Builder()
			.setClient(new ApacheClient(UnsafeHttpsClient.createUnsafeClient()))
			.setEndpoint(TEST_URL).setLogLevel(LogLevel.FULL).build()
			.create(MutiboSvcApi.class);

	private Quiz video = TestData.randomVideo();
	...
	public void testRedirectToLoginWithoutAuth() throws Exception {
		...
		MutiboSvcApi videoService = new RestAdapter.Builder()
				.setClient(
	...
	public void testDenyVideoAddWithoutLogin() throws Exception {
		...
		Collection<Quiz> videos = videoService.getQuizList();
