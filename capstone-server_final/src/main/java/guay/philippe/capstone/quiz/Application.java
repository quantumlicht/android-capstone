package guay.philippe.capstone.quiz;

import guay.philippe.capstone.auth.OAuth2SecurityConfiguration;
import guay.philippe.capstone.quiz.json.ResourcesMapper;
import guay.philippe.capstone.quiz.repository.CompletedQuiz;
import guay.philippe.capstone.quiz.repository.CompletedQuizRepository;
import guay.philippe.capstone.quiz.repository.Player;
import guay.philippe.capstone.quiz.repository.PlayerRepository;
import guay.philippe.capstone.quiz.repository.QuizRepository;
...
// VideoRepository
@EnableJpaRepositories(basePackages = "guay.philippe.capstone.quiz")
...
@ComponentScan(basePackages = { "guay.philippe.capstone.player.repository", "guay.philippe.capstone.quiz.repository","guay.philippe.capstone.completedquiz.repository"})
