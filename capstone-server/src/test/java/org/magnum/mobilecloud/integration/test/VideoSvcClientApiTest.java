...
import guay.philippe.capstone.quiz.client.QuizSvcApi;
import guay.philippe.capstone.quiz.repository.Video;
...
public class VideoSvcClientApiTest {
	...
	private QuizSvcApi videoService = new RestAdapter.Builder()
			.setClient(new ApacheClient(UnsafeHttpsClient.createUnsafeClient()))
			.setEndpoint(TEST_URL).setLogLevel(LogLevel.FULL).build()
			.create(QuizSvcApi.class);
