...
//
@RepositoryRestResource(path = QuizSvcApi.VIDEO_SVC_PATH)
public interface VideoRepository extends CrudRepository<Video, Long>{
	...
	public Collection<Video> findByName(
			...
			// search for Videos
			@Param(QuizSvcApi.TITLE_PARAMETER) String title);
	...
	public Collection<Video> findByDurationLessThan(
			...
			// search for Videos
			@Param(QuizSvcApi.DURATION_PARAMETER) long maxduration);
